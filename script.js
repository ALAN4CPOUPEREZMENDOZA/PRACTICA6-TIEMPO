...
var resultado;
//Se usa el operador === igualdad estricta compara ambos valores  y determina si son 100% uiguales
if (unidad_origen === unidad_destino){
 ...
 if(unidad_destino ==='minutos'){
    ...
    resultrado=valor/3600; //3600 segundos es equivalente a una hora
 }else if (unidad_destino === 'dias'){
    resultado=valor/86400; //86400 segundos es equivalente a 24 horas
  ...
  if(unidad_destino === 'segundos'){
    ...
    resultado=valor/1440; //1440 minutos es equivalente a un dia
...
document.getElementById('resultado').innerText = valor + " " + unidad_origen + "son quivalentes a" + resultado.toFixed(2) + " " + unidad_destino + ".";
